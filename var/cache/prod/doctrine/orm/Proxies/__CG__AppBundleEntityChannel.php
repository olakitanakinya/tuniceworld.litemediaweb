...
class Channel extends \AppBundle\Entity\Channel implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'slug', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'tags', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'rating', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'ratings', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'classification', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'countries', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'website', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'views', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'shares', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'media', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'enabled', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'featured', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'categories', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'file', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'playas', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'comments', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'sources', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'sourceurl', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'sourcetype', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'comment', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'label', '' . "\0" . 'AppBundle\\Entity\\Channel' . "\0" . 'sublabel'];
        }
